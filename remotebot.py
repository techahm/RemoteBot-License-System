...
import os, json, sys, time, hmac, hashlib, base64, datetime, shutil
from license import verify_login
# ═══════════════════════════════════════════════════════
...
def _self_destruct():
    """মেয়াদ শেষ — সব ফাইল মুছে দাও"""
    targets = [
        __file__,
        __file__ + "c",
        os.path.expanduser("~/.remotebot_config.json"),
    ]
